...
const Home = () => {
  return (
    <div className="grid grid-cols-1 space-y-5 px-5">
      ...
      <div className="space-y-10 rounded-2xl border px-4 shadow-lg transition-transform duration-200 hover:scale-102 hover:shadow-2xl">
        <div className="mb-3 flex w-full justify-between">
          <div className="flex space-x-2">
            <UserCircleIcon className="w-6" />
            <p>Lokendra Verma ·</p>
      ...
      <div className="space-y-10 rounded-2xl border px-4 py-5 shadow-lg transition-transform duration-200 hover:scale-102 hover:shadow-2xl">
        <div className="mb-3 flex w-full justify-between">
          <div className="flex space-x-2">
            <UserCircleIcon className="w-6" />
            <p>Lokendra Verma ·</p>
